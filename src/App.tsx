  ...
  return (
    <main className="h-min-[100vh] bg-[url('../public/noise.svg')] font-normal px-8">
      <nav className="flex justify-between max-w-6xl mx-auto mb-36 pt-16">
        <div>
          <a className="font-display text-zinc-100 text-2xl border-teal-200 border-4 rounded-md px-2 py-1 block">
            VIEW RESUME
          </a>
        </div>
        <div className="flex justify-between w-72 max-w-xl items-center">
          <a href="https://github.com/redmor1">
            <FontAwesomeIcon
              icon={faGithub}
              className="text-3xl text-zinc-100 rounded-md"
            ></FontAwesomeIcon>
          </a>
      ...
      >
        <h1 className="font-display text-zinc-400 text-7xl text-center mb-24">
          Projects
        </h1>
        <Project />
        <ProjectReverseTemp />
